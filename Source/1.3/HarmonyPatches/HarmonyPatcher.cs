...
namespace Empire_Rewritten.HarmonyPatches
{
    public static class HarmonyPatcher
    {
        ...
        public static void DoPatches()
        {
            ...
            harmony.Patch(typeof(PlaySettings).GetMethod(nameof(PlaySettings.DoPlaySettingsGlobalControls)),
                          null,
                          new HarmonyMethod(typeof(PlaySettingsControlsPatch), nameof(PlaySettingsControlsPatch.Postfix)));

            harmony.Patch(typeof(SettleUtility).GetMethod(nameof(SettleUtility.AddNewHome)),
                          null,
                          new HarmonyMethod(typeof(SettleUtilityPatch), nameof(SettleUtilityPatch.Postfix)));

            harmony.Patch(typeof(WorldInspectPane).GetProperty("TileInspectString", BindingFlags.NonPublic | BindingFlags.Instance)?.GetMethod,
                          null,
