...
{
    internal static class FloatMenuOptionCreator
    {
        /// <summary>
        ...
        [NotNull]
        [ItemNotNull]
        public static List<FloatMenuOption> CreateFloatMenuOptions<T>([NotNull] List<T> defs, [NotNull] Action<T> floatMenuAction) where T : Def
        {
