...
{
    /*
    public class FactionPawnManager
    {
    ...
    public class FactionPawnManager : IExposable
    {
        ...
        {
            PawnGenerationRequest generationRequest = new PawnGenerationRequest(faction.RandomPawnKind(), mustBeCapableOfViolence: true, faction: faction, fixedIdeo: faction.ideos.PrimaryIdeo, colonistRelationChanceFactor: 0);
            ...
            //Replace at index
            //TODO I'm not sure this is strictly necessary, as List<Pawn> is already a reference?
